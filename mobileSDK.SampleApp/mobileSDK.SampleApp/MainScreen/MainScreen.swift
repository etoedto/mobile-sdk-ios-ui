...
//  mobileSDK.SampleApp
//
//  Created by Etoedto on 18.08.2022.
//
...
struct MainScreen: View {
    ...
    @State var apiHost: String = Etoedto.apiHost
    @State var socketHost: String = Etoedto.socketHost
    ...
    func resetUrls() {
        apiHost = Etoedto.apiHost
        socketHost = Etoedto.socketHost
    }
